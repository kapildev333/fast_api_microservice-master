...
class OcrMethod(Ocr):
    ...
    def cropRoi(self, img, bbox, denoise):
        ...
        id_infos = ["License", "Issued", "Expires", "Date of Birth"]
        crop_img_names = []
        lw_thresh = 1
        up_thresh = 1
...
class EasyOcr(OcrMethod):
    ...
    def ocrOutput(self, img_name, img, bbox):
        ...
        # print(crop_img_names)
        id_infos = ["License", "Issued ", "Expires ", "Date of Birth "]
        jsonData = JsonData()
        text_output = {"License": "", "Issued": "", "Expires": "", "Date of Birth": ""}
        ...
        text_output["DateofBirth"] = self.getonlyDigits(text_output["Date of Birth"])
