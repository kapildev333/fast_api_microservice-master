...
class SsdFaceDetector(FaceDetector):
    ...
    def findFace(self, img):
        ...
        modelFile = str(Path(__file__).resolve().parent) + '/' + "model/res10_300x300_ssd_iter_140000.caffemodel"
        configFile = str(Path(__file__).resolve().parent) + '/' + "model/deploy.prototxt.txt"
